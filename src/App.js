...
const NOTES = [
  ...
  {
    id: 2,
    image: "/public/images/Rikshaw Run- Gangtok to Kochi- Omkar Dhareshwar- Finish Line.jpg", // ← add this
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        {/* Section label — gives it an identity anchor */}
        <div className="reveal" style={{ marginBottom: "40px" }}>
          <ODLabel>What People Say</ODLabel>
        </div>
        ...
        >
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              {/* Opening quote mark — large serif, decorative */}
              <div>
                <div
                  style={{
                    ...F.serif,
